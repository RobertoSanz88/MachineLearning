...
- Método [EarlyStopping](#id6) : para evitar overfit/variance
- Método [ModelCheckpoint](#id6) : para grabar el modelo que ha conseguido mejor precisión durante la iteración
